...
export default function Card6({ entry, userId }) {
  ...
  return (
    <div className="cursor-pointer w-[17rem] h-full bg-gradient-to-tr from-indigo-700 via-violet-600 to-fuchsia-500 rounded-3xl border border-violet-400 shadow-lg p-6 flex flex-col justify-between text-white hover:scale-105 transition-transform select-none">
      {/* Date + Time */}
      ...
      {/* Content Preview */}
      <div className="bg-violet-900 bg-opacity-30 rounded-xl h-24 mt-4 p-3 text-sm opacity-70 overflow-hidden">
        {entry.content}
      </div>
      ...
      <div className="flex justify-end mt-3">
        ...
        >
          {isBookmark ? (
            <BookmarkIcon className="text-fuchsia-900 text-sm" />
          ) : (
